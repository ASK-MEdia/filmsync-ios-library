...
- (void)startListening:(FilmSync*)aListener {
...
- (void)initializeAudioSession {
    ...
    sampleRate = [myAudioSession sampleRate];
    ...
    if (frontDataSource)
    {
        ...
        if (!result)
        {
            ...
            NSLog(@"MicPort setPreferredDataSource failed");
        }
    }
    ...
    {
        // an error occurred. Handle it!
        NSLog(@"MicPort setPreferredInput failed");
    }
